            ...
            public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                ...
                else
                {
                    for (int i = 0; i < data.size(); i++) {
                        ...
                        /*velocity = averageKec / averageKec_Count;
                        if (velocity <=40)
                        {
                            Log.d("velocity", String.valueOf(df.format(velocity)));
                        }
                        if (velocity >= 41 && averageKec <= 60)
                        {
...
// speed d atas 0 = ijo, krg dari sama dg 40 = kuning, lebih dari 41 dan krg dari 60 = merah
   ...
   /* private void updateMapType() {
    ...
    /*public void profileDriver(View view) {
